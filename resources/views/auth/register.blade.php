                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" value="e.g Godfred" name="name" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" value="e.g email@gmail.com" name="email" value="{{ old('email') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('contry') ? ' has-error' : '' }}">
                            <label for="contry" class="col-md-4 control-label">Country</label>
